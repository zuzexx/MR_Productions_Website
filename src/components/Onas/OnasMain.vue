<template>
  <section class="pt-16 h-auto bg-zinc-800">
    <Text
      ...
      text="Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quod sit ipsum
    ...
    <article class="pt-32">
      <div
        class="w-11/12 flex flex-col justify-center mx-auto text-left xl:flex-row xl:w-4/6"
      >
        <img
...
<script>
import Text from "../SharedComponents/Text.vue";
export default {
  name: "OnasMain",
  components: { Text },
};
